...
## [질문 생성 규칙]
    ...
    2. 참고자료의 [면접 기출 질문]을 참고하여 기출 변형 질문을 생성하세요.
    ...
    6. 지원자료에서 지원자의 전공과 프로젝트를 추출해 직무역량 질문을 생성하세요.
...
## [질문 생성 규칙]
    ...
    5. 지원자료에서 과제나 프로젝트를 추출하고 프로젝트 경험 질문 생성에 참고하세요.

    6. 지원자료에서 희망 직무, 기술스택을 추출하고 기술 관련 질문 생성 시 참고하세요.
...
## [질문 생성 규칙]
    ...
    6. 지원자료에서 수행했던 과제나 프로젝트를 추출하고, 프로젝트 경험 질문 생성에 참고하세요.

    7. 지원자료에서 사용 가능한 툴이나 장비, 기법을 추출하고 실무 역량 기반 질문 생성 시 참고하세요.
...
ev_score_rule = """
점수 산정 기준:
- 90~100점: 탁월함. 모범적인 답변으로 실제 면접에서도 높은 평가를 받을 수 있음.
- 70~89점: 우수함. 약간의 보완만 있다면 훌륭한 답변.
- 50~69점: 보통. 기준은 충족하지만 설득력이나 명확성이 부족함.
- 30~49점: 미흡. 중요한 요소가 빠져있거나, 구조가 비논리적임.
- 0~29점: 부족. 의도 파악 실패, 경험 부족, 직무 연관성 없음 등 심각한 문제 있음.
"""
